...
2. `02_review_questions.md`：再把主链条改写成复盘问题。
3. `01_repeated_concepts_map.md`：最后处理看似重复、实则同源的概念组。
...
- `03_common_compression_rules.md`：总结“多个术语其实在讲同一件事”的压缩规则。
- `04_trade_examples_from_framework.md`：用具体走势验证这些总结是否有用。
