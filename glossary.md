...
微型通道。紧通道的极端形式，几乎没有回调。牛微通道中每根低点不低于前一根；熊微通道中每根高点不高于前一根，K 线颜色不必完全一致。
...
突破测试。突破入场后，市场回到原始 stop-entry 入场价附近，测试突破交易者的 breakeven stop；常在约 5—10 根后出现，也可能早至 1—2 根或晚至 20 根以上。它也常同时测试旧突破区域是否转为支撑或阻力。

### Breakout Mode

突破模式。多空突破的概率接近中性，交易者等待方向选择；常见于区间、三角形、ii/iii、ioi 等结构，但不要求价格一定先“压缩”。首次突破经常失败。
...
暂停 K 线。没有延续趋势极值、但也没有构成 bar pullback 的 K 线。例如牛趋势中高点未创新高，而低点没有低于前一根低点；它是暂停，不应和回调 K 线混为一谈。
...
High 1/2/3/4。牛向回调中，第 1、2、3、4 次 K 线高点达到或越过前一根高点、从而可触发买入 stop 的恢复尝试；重点是实际 stop-entry 触发，不是仅凭外观数数。

### L1 / L2 / L3 / L4

Low 1/2/3/4。熊向回调中，第 1、2、3、4 次 K 线低点达到或跌破前一根低点、从而可触发卖出 stop 的恢复尝试；重点是实际 stop-entry 触发。
...
微型量度缺口。一根强趋势 K 线前后的 K 线区间彼此不重叠，例如强牛 K 线后一根的低点高于其前一根的高点；该空隙可作为很短期的 measuring gap 线索。
...
量度缺口。突破缺口在后续价格推进中保持开放后，可把缺口附近作为运动中点，投射与突破前一段近似相等的 measured move。它是市场走出来后得到的分类与目标线索，不是看到任何缺口就能预先确定。

### Exhaustion Gap

衰竭缺口。缺口后来很快被回补、趋势无法继续，因此事后被归类为趋势末端的 exhaustion gap；“很大”或“出现在图表右侧”都不是充分条件，缺口区域应在回补处终止。
