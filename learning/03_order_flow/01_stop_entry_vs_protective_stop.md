...
中文里很多地方都叫“止损单”，但 Al Brooks 语境中必须区分 stop entry 和 protective stop。混淆二者会误读 H1/H2/L1/L2、signal bar 和 trapped traders。
...
Al Brooks 公开 manual 中也强调，stop order entry 通常更适合多数学习者，因为市场至少已经朝交易方向走了一跳。强突破中直接市价或收盘附近追随也可能顺势，但对初学者更难。
...
Al Brooks 常说 one tick above / below，重点不是具体 tick size，而是 signal bar 高低点附近可能集中入场单和保护性止损。价格越过这些点后，要观察是否有跟进。

## 与执行规则的边界

本页只负责区分入场 stop 与保护性 stop，并解释失效事实、结构锚点和订单价格的关系。如何选择 stop 方案、计算仓位、保护首个成交以及移动或提前退出，只由[执行手册的 stop、成交与管理章节](../../EXECUTION_MANUAL.md#7-protective-stop目标和仓位)规定，不在学习层维护第二份动作清单。
