...
来源审计见 [`reference/official_sources.md`](../../reference/official_sources.md) 中的 `SRC-TRADING-RANGES`、`SRC-STOP-ORDERS`，以及 [`reference/audit_matrix.md`](../../reference/audit_matrix.md)。
