...
先读[方法与读图主线](../00_method/00_al_brooks_thesis.md)，知道形态标签不能替代 context 和交易数学。

## 完成标准

能够对一段隐藏未来的走势给出当前 market cycle，并指出哪条新证据会维持或改变判断，而不是只贴静态标签。

## 本章文件

1. **核心** [`00_market_cycle.md`](00_market_cycle.md)：建立 market cycle 的基础层级、连续谱和动态更新问题。
