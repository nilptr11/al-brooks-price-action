...
Gap reversal 的最低定义是当前 K 线向 gap 方向越过前一根 K 线至少一跳；例如 gap up 后第二根跌破第一根低点一跳。它是拒绝路径的早期事件，不保证价格已经触及真正的 gap 区域，更不是交易许可；开盘案例中更可靠的反转通常还要结合昨日高低点、二次信号、signal bar 和后续跟进。
...
- **市场周期**：早期 gap 常支持 breakout 或 tight channel；成熟趋势末端的大 gap 需要同时观察是否形成 climax。
