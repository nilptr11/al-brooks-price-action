...
1. 当前市场状态、context 和位置是否支持一个清晰交易想法，还是应该等待？
2. 什么可观察价格行为构成 setup 和具体入场条件？
3. 什么事实会使 premise 失效，哪些回调仍属正常测试？
4. Protective stop 与第一现实目标分别在哪里？
5. 触发后需要看到什么新证据，才继续按原想法管理？
6. 概率、风险、回报、成本和仓位是否来自同一方案并且合算？
