...
来源审计见 `reference/official_sources.md` 中的 `SRC-GLOSSARY`、`SRC-STOP-ORDERS`、`SRC-10-PATTERNS`、`SRC-STRONG-LEGS-2016`、`SRC-BREAKOUTS-2025`、`SRC-LIVE-TR-BO-2021`，以及 `reference/audit_matrix.md`。
