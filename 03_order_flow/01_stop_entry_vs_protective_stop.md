...
- Protective stop 是最终保护；出现预写的合理反向信号、强反向 breakout 或命题失效时，可以在 stop 触发前退出，但不能只依赖 mental stop。

来源审计见 `reference/official_sources.md` 中的 `SRC-STOP-ORDERS`、`SRC-RISK-113`、`SRC-BREAKOUTS-2025`、`SRC-GOOD-TRADE-2017`，以及 `reference/audit_matrix.md`。
