...
趋势延续常使用 stop entry 越过 signal bar。H1/H2/L1/L2 的几何计数见[形态页](../04_patterns/02_h1_h2_l1_l2.md)；课程宽泛的 second entry、严格 entry-bar 顺序和账户实际成交的区别见[接受与订单逻辑专题](../03_acceptance_and_order_logic/03_second_entries_and_traps.md)。
...
相关来源见 [`reference/official_sources.md`](../../reference/official_sources.md) 中的 `SRC-10-PATTERNS`、`SRC-GLOSSARY`、`SRC-TREND-CHANNELS`、`SRC-STOP-ORDERS`、`SRC-STRONG-LEGS-2016`、`SRC-RISK-113`、`SRC-POSITION-SIZE`、`SRC-COURSE-01-36`（课程 09A–09C、13A–14E、17A–17B、22C、31A–31D）与 `SRC-COURSE-37-52`（课程 41A–41D、43A–46E）。
