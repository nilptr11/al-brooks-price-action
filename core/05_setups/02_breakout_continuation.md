...
相关来源见 [`reference/official_sources.md`](../../reference/official_sources.md) 中的 `SRC-GLOSSARY`、`SRC-10-PATTERNS`、`SRC-STOP-ORDERS`、`SRC-STRONG-LEGS-2016`、`SRC-BREAKOUTS-2025`、`SRC-LIVE-TR-BO-2021`、`SRC-COURSE-01-36`（课程 15A–15G、18B、20B、24E、29E、31D）与 `SRC-COURSE-37-52`（课程 41A–42C）。
