...
相关来源见 [`reference/official_sources.md`](../../reference/official_sources.md) 中的 `SRC-TRADING-RANGES`、`SRC-STOP-ORDERS`、`SRC-SCALE-IN-TRENDS`、`SRC-COURSE-01-36`（课程 18D p1548–1553）与 `SRC-COURSE-37-52`（课程 47B p838–839、47D p883–885、49E p1171）。
