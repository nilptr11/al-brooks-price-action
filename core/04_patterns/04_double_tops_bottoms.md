...
相关来源见 [`reference/official_sources.md`](../../reference/official_sources.md) 中的 `SRC-GLOSSARY`、`SRC-COURSE-01-36`（课程 09B、21D、22A–22D、25A–25B、27A–27B）与 `SRC-COURSE-37-52`（课程 38A–39D）。
