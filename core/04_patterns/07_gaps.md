...
相关来源见 [`reference/official_sources.md`](../../reference/official_sources.md) 中的 `SRC-GLOSSARY`、`SRC-STRONG-LEGS-2016`、`SRC-OPENING-REVERSALS-2017`、`SRC-PATTERNS-OPEN-2018`、`SRC-LIVE-TR-BO-2021`、`SRC-COURSE-01-36`（课程 10A–11D、15E、29A–29C）与 `SRC-COURSE-37-52`（课程 42A–42B、48F）。
