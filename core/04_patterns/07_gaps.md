...
- Breakout、body gap 和 micro measuring gap 对强度与接受的作用，回到[突破和突破模式](../01_market_cycle/03_breakouts_and_breakout_mode.md)及[接受、失望与失败证据](../03_order_flow/00_acceptance_and_failure.md)。
