...
1. 先判断基础状态更接近趋势还是交易区间；若是趋势，再区分获接受的 breakout phase（spike）或 channel，并另外记录 breakout mode、高潮式推进或转换过程。看不清时保持未分类。
...
| [reference](reference/README.md) | 保存派生术语速查、正式来源和核心概念覆盖关系 |
